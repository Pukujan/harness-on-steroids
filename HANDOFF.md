...
**v34:** empty `codex_exec` are short (median 9 lines). Not Work gold.

**v35:** nonempty `codex_exec` 31/105 patch vs Work 1/83. Do not average.
...
**v38:** live R3 caption is exec 81 / shell 2 (not 79).

**v39:** vscode nonempty 12/13 patch, 13/13 shell-first.

**v40:** patch rates Work 1/83, Desktop 1/994, exec 31/105, vscode 12/13.

**v41:** spec includes that patch-rate table.

**v42:** wait among nonempty: Work 31/83, vscode 0/13.

**v43:** send_message Work 25, vscode 0, exec 0. spawn Work 2.

**v44:** update_plan Work 0; exec 11 (8 first); vscode 6.

**v45:** originator dashboard (patch/wait/send/plan). Imitate Work only.
