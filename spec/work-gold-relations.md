...
| R3 | First look is exec/read, not cwd shell | Work first exec **81**, shell **2** |
...
| R6 | send/Task never first; look burst first | 83/83 first call ≠ send_message; median 15 tools before send |
