...
5. **Split only if multi-piece.** After a look burst, Todowrite / Task / send to a **named target**. One slice does not spawn. Never Task as tool 1. `spawn_agent` is rare (2/85).
