...
| originator | patch | wait | send | update_plan | cwd shell | js |
| --- | --- | --- | --- | --- | --- | --- |
| Work | **1/83** | **31/83** | **25** | **0** | **2** | **5** |
| Desktop | **1/994** | 88/994 | 17 | 2 | 4 | 17 |
| `codex_exec` | **31/105** | 16/105 | 0 | 11 | **45** | 1 |
| vscode | **12/13** | **0/13** | **0** | 6 | **13** | 1 |
