...
- Per bounded invocation timeout: 25.0 seconds
...
| grok-build | jev | 1 | 3 | 0 | 0 | 0/1 | no=1 | 0 | 3 | 3 |
| opencode | baseline | 1 | 3 | 3 | 3 | 0/1 | no=1 | 0 | 0 | 0 |
| opencode | jev | 1 | 3 | 0 | 0 | 0/1 | no=1 | 0 | 3 | 3 |
| pi | baseline | 1 | 3 | 3 | 0 | 0/1 | no=1 | 0 | 0 | 0 |
| pi | jev | 1 | 3 | 0 | 0 | 0/1 | no=1 | 0 | 3 | 3 |
...
| opencode | `0d6ca4607eaf` | jev | 3 | 0 | not_executed=3 | no | no | 0 | 3 | 3 | empty |
| grok-build | `0d6ca4607eaf` | baseline | 3 | 3 | timeout=3 | no | no | 0 | 0 | 0 | empty |
| grok-build | `0d6ca4607eaf` | jev | 3 | 0 | not_executed=3 | no | no | 0 | 3 | 3 | empty |
| pi | `0d6ca4607eaf` | baseline | 3 | 3 | fail_1=2, ok=1 | no | no | 0 | 0 | 0 | empty |
| pi | `0d6ca4607eaf` | jev | 3 | 0 | not_executed=3 | no | no | 0 | 3 | 3 | empty |
...
Source run id: `jev-long-smoke-20260921`
