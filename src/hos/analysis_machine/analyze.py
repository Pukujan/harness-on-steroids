        ...
        return {
            ...
            "lanes": {
                "codex": {
                    ...
                    "inspection_before_mutation": inspection_before,
                    "inspection_before_mutation_rate": _rate(
                        inspection_before, mutation_episodes
                    ),
                    "verification_after_mutation": verification_after,
                    "verification_after_mutation_rate": _rate(
                        verification_after, mutation_episodes
                    ),
